...
const LoginPage = () => {
  ...
  <div class="relative">
    ...
    <div id="form-container" class="bg-white p-6 sm:p-8 md:p-16 rounded-lg shadow-2xl w-72 sm:w-80 md:w-80 lg:w-80 xl:w-80 relative z-10 transform transition duration-500 ease-in-out">
      <h2 id="form-title" class="text-center text-3xl font-bold mb-10 text-gray-800">Log in</h2>
